...
Local Ops v1.8.3 ships an Apple Silicon (`arm64`) macOS package. Intel (`x64`) and universal packages are not part of the current release matrix.
...
desktop/dist/Local-Ops-1.8.3-arm64.dmg
```
